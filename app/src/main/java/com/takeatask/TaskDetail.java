...
/*	protected void showDialog(String msg) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		name.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(TaskDetail.this, ViewProfile.class);
				startActivity(i);
	...
	public class DeletePost extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			db = new TransparentProgressDialog(TaskDetail.this,
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (status.equalsIgnoreCase("true")) {
					...
					Toast.makeText(TaskDetail.this, "Error occured...",
