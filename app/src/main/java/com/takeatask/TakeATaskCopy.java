 ...
 */
public class TakeATaskCopy extends Activity implements View.OnClickListener {
    ...
    public class getTaskList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                db = new TransparentProgressDialog(TakeATaskCopy.this,
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.chat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(TakeATaskCopy.this, ChatScreen.class);
                    startActivity(i);
                }
            });

            holder.task_detail.setOnClickListener(new View.OnClickListener() {
        ...
        private void goToTaskDetailCopy(int pos) {
            ...
            Intent i = new Intent(TakeATaskCopy.this, TaskDetailCopy.class);
            startActivity(i);
        ...
        class ViewHolder {
            TextView price, task_name, address,  task_detail;
            ...
            try {
                if (result.size() > 0) {
                    ...
                    for (int i = 0; i < result.size(); i++) {
                        Constants.GLOBAL_categoryList.add(result.get(i)
                                .get("title"));
    ...
    private void showFilterDialog() {
        final Dialog dialog;
        dialog = new Dialog(TakeATaskCopy.this);
        ...
        mAdapter1 = new MyAdapter1(TakeATaskCopy.this, cat_list);
